						...
						return (
							<li key={i}
								...
								<ImageListItem
									...
									newWin={1}
									detailUrl={'#/photographers/'+personId+'/works/'+v.contentId}
									 />
									}
							</li>
						)
...
var PhotographersList = React.createClass({
					...
					return (
						<li key={i} className="item-box">
						  <div className="info-box">
							...
							<span className="job">{v.level+'级摄影师'}</span>
							<span className="btn-js btn-blue-1-js" style={{display:'none'}}>查看他的档期</span>
						  </div>
...
module.exports = PhotographersList;